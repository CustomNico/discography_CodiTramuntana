...
class LpsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lp" do
    assert_difference('Lp.count') do
      post lps_url, params: { lp: { artist_id: @lp.artist_id, description: @lp.description, name: @lp.name } }
    end
  ...
  test "should update lp" do
    patch lp_url(@lp), params: { lp: { artist_id: @lp.artist_id, description: @lp.description, name: @lp.name } }
